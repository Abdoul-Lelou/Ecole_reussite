...
<body>
    ...
    <main class="m-3 d-flex justify-content-center position-relative">
    ...
    <div class="mt-5 d-flex justify-content-center" style=" width: 50%;">
        <h1 class="text-info text-center m-5">Presentation</h1>
        <p class="text-center text-uppercase m-5"><strong> <i> l'école de la réussite est un bon établissement primaire et secondaire qui pour objectifs principale
