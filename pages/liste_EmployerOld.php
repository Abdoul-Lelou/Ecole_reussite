...
$employer = new ModelUser();

$roles = "employer";
$user = $employer->getUserByRole($roles);
                    ...
                    <table class="table m-2 ">
                        ...
                        <tbody>
                            ...
                            while ($a = $sql->fetch()) {
                                ...
                                echo '<td>' . $a['tel'] . '</td>';
                                echo '<td>
                                <button type="button" class="btn btn-outline-primary">archiver</button>
                                <button type="button" class="btn btn-outline-danger">modifier</button>
